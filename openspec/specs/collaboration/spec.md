...
MUST: список активных пользователей, курсоры с цветом, **монограммой или фото (`photoURL` в `presence`)** и подписью, индикаторы typing / move, блокировки на редактируемых объектах.
